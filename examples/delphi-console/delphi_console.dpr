...
begin
  try
    ...
    try
      ...
      // set metadata
      pdf.Creator := 'THaruPDF in Delphi';
      ...
      page.ShowText('THaruPDF in Delphi');
      ...
      page.TextRect(RectF(0, page.Height - 300, page.Width, page.Height - 350),
        HPDF_TALIGN_CENTER or HPDF_VALIGN_CENTER, 'Hello World!', len);

      page.EndText;

      // draw image, center horizontally
      png_image := pdf.LoadPngImageFromFile('resources' + PathDelim + 'world.png');
      page.DrawImage(png_image, (page.Width / 2) - (png_image.Width / 2), page.Height - 300);

      // save the document to a file
      pdf.SaveToFile('demos' + PathDelim + 'delphi.pdf');
    finally
      pdf.Free;
    end;
  except
